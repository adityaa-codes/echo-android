...
internal class EchoClientImpl(
    ...
    private val url = buildString {
        if (builder.clientConfig.cluster != null) {
            append("wss://ws-${builder.clientConfig.cluster}.pusher.com:443/app/${builder.clientConfig.apiKey}?protocol=7&client=echo-kotlin&version=1.0.0")
        } else {
            ...
            append("/app/${builder.clientConfig.apiKey}?protocol=7&client=echo-kotlin&version=1.0.0")
        }
    }
