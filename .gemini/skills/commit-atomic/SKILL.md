---
name: commit-atomic
description: Analyzes the current workspace changes and creates one or more atomic, conventional commits. Use when managing source control to ensure high-quality Git histories.
---
# Commit Atomic

## Overview
This skill provides procedural guidance for analyzing workspace changes, grouping them into logical units, and writing high-quality commit messages conforming to the Conventional Commits standard.
